...
import time
import os
from train_raw import receive_arg
...
if __name__ == '__main__':
    ...
    test_QP = 'QP00'
    ckp_path = sorted(glob.glob(f'./exp/STDR/{test_QP}' + '/*.pt'))[0]
    print(ckp_path)
    qp_yuv = sorted(glob.glob(f'/data/lk/datasets/MFQEv2_dataset/train_108/HM16.5_LDP/{test_QP}' + '/*.yuv'))
    raw_yuv = sorted(glob.glob('/data/lk/datasets/MFQEv2_dataset/train_108/raw' + '/*.yuv'))
